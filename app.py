...
#     if not api_key:
#         return []  # Return empty list if API key is not provided
...
#     api_key = st.text_input('Groq API Key', value=api_key_default, type='password', help='Enter your Groq API key')
#     available_models = fetch_models(api_key)  # Fetch available models
#     model = st.selectbox('Select Model', options=available_models, help='Select a language model')
